...
for x = (-P/2):1:(P/2)-1
     for y = (-Q/2):1:(Q/2)-1
        ...
        H_3(x+(P/2)+1,y+(Q/2)+1) = 1/(1+(D_0/D)^10);
     end
end
...
subplot(2,2,2);
imshow(H_1,[0 1]);
xlabel('Butterworth Highpass (D_{0}=100,n=1)');
subplot(2,2,1);
...
subplot(2,2,2);
imshow(H_2,[0 1]);
xlabel('Butterworth Highpass (D_{0}=100,n=3)');
subplot(2,2,1);
...
subplot(2,2,2);
imshow(H_3,[0 1]);
xlabel('Butterworth Highpass (D_{0}=100,n=5)');
subplot(2,2,1);
...
subplot(2,2,2);imshow(g_1+f);title('n = 1');
subplot(2,2,3);imshow(g_2+f);title('n = 3');
subplot(2,2,4);imshow(g_3+f);title('n = 5');